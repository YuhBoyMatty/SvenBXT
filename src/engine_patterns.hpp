...
namespace patterns
{
	...
	namespace engine
	{
		...
		PATTERNS(ClientDLL_Init,
			"Sven-5.26-rc1",
			"81 EC 04 02 00 00 A1 ?? ?? ?? ?? 33 C4 89 84 24 ?? ?? ?? ?? 68 00 02 00 00 8D 44 24 ?? 6A 00 50 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 ?? 68 FF 01 00 00 50 E8 ?? ?? ?? ?? 83 C4 18 83 3D ?? ?? ?? ?? 00 0F 84 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 ?? FF D0 FF 35 ?? ?? ?? ??",
			"Sven-5.23",
			"68 ?? ?? ?? ?? FF 15 ?? ?? ?? ?? A1 ?? ?? ?? ?? 83 C4 1C 85 C0 74 0A 68 ?? ?? ?? ?? FF D0 83 C4 04 E8 ?? ?? ?? ?? 68 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 04 A3 ?? ?? ?? ?? 85 C0 74 3A",
			"Sven-5.25",
			"81 EC 04 02 00 00 A1 ?? ?? ?? ?? 33 C4 89 84 24 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8D 44 24 ?? 68 00 02 00 00 50 E8 ?? ?? ?? ?? 83 C4 0C 83 3D ?? ?? ?? ?? 00 0F 84 ?? ?? ?? ?? E8 ?? ?? ?? ?? E8 ?? ?? ?? ?? A1 ?? ?? ?? ?? 85 C0 74 ?? FF D0 FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 68 B0 00 00 00 6A 00 68 ?? ?? ?? ??"
		);
